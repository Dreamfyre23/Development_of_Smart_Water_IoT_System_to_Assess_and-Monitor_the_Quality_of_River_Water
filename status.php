...
<head>
	...
	<script src="./status.angular.js"></script>
...
<body>
	<nav id="topnav">
		<ul id="menu">
			...
			<li class="selected" style="float: right"><a href="./status.php">Status</a></li>
	...
	<div ng-app="myApp" ng-controller="customersCtrl" class="main_div">
		...
		<?php if($isLoggedOn) echo '<table id="status_table">'
			.'<tr>
			    <th>Time</th>
			    <th>Potability</th>
				<th>WQI</th>
			...
			<tr ng-repeat="x in reading">
			    <td>{{x.time}}</td>
			    <td data-status={{x.result}} class="status"></td>
				<td>{{x.wqi}}</td>
				<td data-rating={{x.rating}} class="rating"></td>
		  	</tr>
		</table>';
