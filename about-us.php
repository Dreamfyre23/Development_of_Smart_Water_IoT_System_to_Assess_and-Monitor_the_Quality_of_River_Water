...
<body>
	<nav id="topnav">
		<ul id="menu">
			...
			<li class="selected" style="float: right"><a href="./about-us.php">About</a></li>
	...
	<div ng-app="myApp" class="main_div">
		...
		<h3 style="font-family: 'El Messiri';font-size: 22px;">About This Project</h3>
		<p style="padding: 0px 30px;">Water Quality Monitoring System is an arduino based system to collect water quality data in the real time and display the data to the authorized user.</p>
	</div>
