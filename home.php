...
<body>
	<nav id="topnav">
		<ul id="menu">
			<li style="float: left"><a href="./home.php"><img style="height:30px;width:150px;" src="Project Logo White.png"/></a></li>
			<li style="float: right"><a id="loginBtn" href="javascript:void(0)"><?php if($isLoggedOn) echo "Logout"; else echo "Login"; ?></a></li>
			<li style="float: right"><a href="./about-us.php">About</a></li>
			<li style="float: right"><a href="./status.php">Status</a></li>
	...
	<div ng-app="myApp" ng-controller="customersCtrl" class="main_div">
		...
		<h3 style="font-family: 'El Messiri';font-size: 22px;">Water Quality Status</h3>
		<?php if($isLoggedOn) echo '<div style="text-align:  center;"><input id="settingsBtn" type="button" value="Settings"/></div>'
		...
		else echo "<h4 style='text-align: center; color: red;'>Please login to view data</h4>";
		?>
	</div>
	<div class="login_div" style="display: none;">
		...
		<div class="login_field">
			<form id="login_form" method="post">
				...
				<span style="font-size: smaller;">For login problems, please <a href="./status.php">Contact Us</a>.</span><br><br>
				<input id="submit-login" type="button" value="Login"/><br><br>
				<span style="font-size: smaller;"><a id="registerBtn" href="javascript:void(0)">Register new ID</a></span><br>
			</form>
		</div>
	</div>
	...
	<div class="settings_div" style="display: none; text-align: center; font-size: smaller;">
		...
		<div class="settings_field">
			<form id="settings_form" method="post">
				...
				Set data warning values:<br><br>
				<input type="number" name="temp_limit" placeholder="Temperature" <?php if(array_key_exists('temp_limit', $_SESSION)) echo "value=".$_SESSION['temp_limit'];?> style="width: 90px; text-align: center;" /><br>
				<input type="number" name="turb_limit" placeholder="Turbidity" <?php if(array_key_exists('turb_limit', $_SESSION)) echo "value=".$_SESSION['turb_limit'];?> style="width: 90px; text-align: center;" /><br>
				<input type="number" name="ph_limit" placeholder="pH" <?php if(array_key_exists('ph_limit', $_SESSION)) echo "value=".$_SESSION['ph_limit'];?> style="width: 90px; text-align: center;" /><br>
	...
	<footer>
		<p style="text-align: center;">Water Quality Monitoring System for River</p>
	</footer>
</body>
</html>
